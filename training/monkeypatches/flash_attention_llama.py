...
# copied from https://github.com/OpenAccess-AI-Collective/axolotl/blob/main/src/axolotl/monkeypatch/llama_attn_hijack_flash.py
...
def _fa_prepare_decoder_attention_mask(
    self,
    attention_mask,
    input_shape,
    inputs_embeds,
